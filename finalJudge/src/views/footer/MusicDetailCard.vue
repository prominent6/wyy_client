<template>
  ...
  >
    <TopNav :isImage="false" :bgc="backgroundMode" />
    <!-- 按钮 -->
    ...
    <div class="changeBackground" @click="changeBackground">
      <svg class="icon black" aria-hidden="true">
        <use xlink:href="#icon-huanbeijing"></use>
      </svg>
    </div>
...
import LyricsScroll from "components/footer/LyricsScroll.vue";
...
export default {
  components: { LyricsScroll, Comment, GoTop, TopNav },
